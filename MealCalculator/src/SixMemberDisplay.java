 ...
 * @author SAFKAT
 */
public class SixMemberDisplay extends javax.swing.JFrame {

    /**
     * Creates new form SixMemberDisplay
     */
    public SixMemberDisplay() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SixMemberDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SixMemberDisplay().setVisible(true);
            }
        });
    }
